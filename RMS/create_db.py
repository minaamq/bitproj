...
def create_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS student_register(eid INTEGER PRIMARY KEY AUTOINCREMENT,f_name text,l_name text,email text,question text,answer text,password text)")
    con.commit()
create_db()
